...
class traindata:
    ...
    def trainGenderClassficationData(malePath, maleLabel, femalePath, femaleLabel, height, width):
        ...
        imagesMale, labelsMale = traindata.get_data_labels(
            malePath, maleLabel, height, width)

        imagesFemale, labelsFemale = traindata.get_data_labels(
            femalePath, femaleLabel, height, width)
    ...
    def trainDataForFacialRecognition():
        ...
        imageNames.append(
            '/Users/ekumar/EKProject/projects/facedetection/pi/face-detection/face-detection/images/face_recognition/img_1.jpg')
        labels.append(2)

        imageNames.append(
            '/Users/ekumar/EKProject/projects/facedetection/pi/face-detection/face-detection/images/face_recognition/img_2.jpg')
        labels.append(2)

        imageNames.append(
            '/Users/ekumar/EKProject/projects/facedetection/pi/face-detection/face-detection/images/face_recognition/img_3.jpg')
        labels.append(2)

        imageNames.append(
            '/Users/ekumar/EKProject/projects/facedetection/pi/face-detection/face-detection/images/face_recognition/img_4.jpg')
        labels.append(2)

        imageNames.append(
            '/Users/ekumar/EKProject/projects/facedetection/pi/face-detection/face-detection/images/face_recognition/nick.jpg')
        labels.append(1)

        imageNames.append(
            '/Users/ekumar/EKProject/projects/facedetection/pi/face-detection/face-detection/images/face_recognition/uma_2.jpg')
        labels.append(3)
    ...
    def enrollTrainingDataWithKairos():
        ...
        for index, image in enumerate(imageNames):
            ...
            kairos.enrollPhotoGallery(
                image_64_encode, labels[index], "face_recognition_OB")
